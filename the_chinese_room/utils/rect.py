...
class Rect(object):
    ...
    (left, top)
            ...
            |    |
            +----+
                (right, bottom) exclusive, outside the rectangle

    for the inclusive (right, bottom)
    use (right_inclusive, bottom_inclusive)
    ...
    def right_inclusive(self, value):
        self.right = value + 1

    @property
    def bottom_inclusive(self):
        return self.bottom - 1

    @bottom_inclusive.setter
    def bottom_inclusive(self, value):
        self.bottom = value + 1
